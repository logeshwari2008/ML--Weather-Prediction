...
## Algorithm
1. Import the required libraries and load the weather dataset into the program.
2. Split the dataset into input features and target weather conditions, then divide it into training and testing sets.
3. Create and train the Random Forest model using the training data to learn weather patterns.
4. Predict weather conditions using the test data and evaluate the model accuracy and performance.
...
## Output:
<img width="1077" height="808" alt="Screenshot 2026-05-13 081644" src="https://github.com/user-attachments/assets/f1c72889-537d-4037-9044-c35a75506e98" />

<img width="1045" height="437" alt="Screenshot 2026-05-13 081658" src="https://github.com/user-attachments/assets/ad4ddedd-a2b5-4b00-9c67-ff67db5f3b33" />
